<template>
	<view>
		...
		<view class="goods-section">
			...
			<!-- 商品列表 -->
			<view class="g-item">
				<image src="../../static/temp/cate15.jpg"></image>
				<view class="right">
					<text class="title clamp">时蔬</text>
					<text class="spec">小番茄 亲情款</text>
					<view class="price-box">
						<text class="price">￥10.8</text>
			...
			<view class="g-item">
				...
				<view class="right">
					<text class="title clamp">鲜果</text>
					<text class="spec">草莓 温情款</text>
					<view class="price-box">
						<text class="price">￥15.8</text>
						<text class="number">x 1</text>
					</view>
				</view>
			</view>
		...
		<view class="yt-list">
			<view class="yt-list-cell b-b">
				...
				<text class="cell-tip">￥26.60</text>
			</view>
			<view class="yt-list-cell b-b">
				<text class="cell-tit clamp">优惠金额</text>
				<text class="cell-tip red">-￥3</text>
			</view>
			<view class="yt-list-cell b-b">
